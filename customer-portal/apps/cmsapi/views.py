...
from models.post import BannerModel, PostModel, PostCommentModel
from exts import db
...
def comment_list():
    comments = PostCommentModel.query.order_by(PostCommentModel.create_time.desc()).all()
    comment_list = []
...
def delete_comment():
    ...
    PostCommentModel.query.filter_by(id=comment_id).delete()
    return restful.ok()
