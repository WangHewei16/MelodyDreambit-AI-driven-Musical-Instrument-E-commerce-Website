 ...
 */
!function(){function f(){
// Reference to tinymce4.7.5 needs to be lazily evaluated since tinymce4.7.5
...
// Delay the init call until tinymce4.7.5 is loaded
...
// Add :tinymce4.7.5 pseudo selector this will select elements that has been converted into editor instances
// it's now possible to use things like $('*:tinymce4.7.5') to get all TinyMCE bound elements.
